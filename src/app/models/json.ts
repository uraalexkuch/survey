      ...
      "elements": [
        {
          ...
          "choices": [
            ...
            {
              "value": "trouble245",
              "text": "Труднощі, пов’язані із місцем розташування підприємства (загроза особистій безпеці через війну)"
            },
            {
              "value": "trouble246",
      ...
      "elements": [
        {
          ...
          "choices": [
            {"value": "troublevpo1",
              "text":"Відсутність необхідної професійної кваліфікації"},
            {"value": "troublevpo2",
              "text":"Пересторога щодо частої зміни місця проживання"},
            {"value": "troublevpo3",
              "text":"Відсутність необхідних документів"},
            {"value": "troublevpo4",
              "text":"Пересторога щодо низької мотивації до праці"},
            {"value": "troublevpo5",
              "text":"Жодних перешкод немає"}
          ],
          "showOtherItem": true,
